...
#with h5py.File(data_path, "r") as f:
 #   print(f.keys())
 #   group=f["obs"]
 #   print( isinstance(group, h5py.Group))
    
 #   for key in group:
    #    read_clean(group[key][...])
    #    print( isinstance(group[key], h5py.Group))
     #   print(group[key])
     #   assert isinstance(group[key][...], np.ndarray)
###########
...
def prepro(filename):
    data_path = "C:/Users/sarah/Documents/cse3810-fp23-main/data/" + filename
